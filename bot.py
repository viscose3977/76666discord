...
class VerificationView(discord.ui.View):
    ...
    async def threads_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            # 這通常表示互動 token 已過期，無法回應
            print("Interaction expired in threads_button callback.")
        except Exception as e:
            print(f"Error in threads_button callback: {e}")
    ...
    async def instagram_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            print("Interaction expired in instagram_button callback.")
        except Exception as e:
            print(f"Error in instagram_button callback: {e}")
    ...
    async def youtube_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            print("Interaction expired in youtube_button callback.")
        except Exception as e:
            print(f"Error in youtube_button callback: {e}")
...
async def on_member_join(member: discord.Member):
    ...
    "有任何狀況或疑問請私訊管理員！\n\n"
    "程式高手也請不吝嗇給予指教，766只會唱歌、不太會寫py。")
    await verification_channel.send(
        "# 【請選擇您想使用的驗證方式】\n"
        "## 若點擊按鈕持續出現「交互失敗」請多嘗試反覆點擊！",
